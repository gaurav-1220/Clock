...
function updateHourAndMinuteHands() {
  ...
  if (dateDisplay) {
    ...
    const month = months[kolkataTime.getMonth()];
  ...
  if (timezoneDisplay) {
    timezoneDisplay.textContent = "Kolkata";
  }
  ...
  try {
    ...
    pane
      ...
      .on("click", () => {
        ...
        document.documentElement.style.setProperty("--minute-marker-opacity", "1");
        document.documentElement.style.setProperty("--inner-shadow-opacity", "0.15");
        document.documentElement.style.setProperty("--reflection-opacity", "0.5");
        document.documentElement.style.setProperty("--glossy-opacity", "0.3");
        document.documentElement.style.setProperty("--hour-number-opacity", "1");
        document.documentElement.style.setProperty("--hour-number-color", "rgba(50, 50, 50, 0.9)");
        document.documentElement.style.setProperty("--minute-marker-color", "rgba(80, 80, 80, 0.5)");
        document.documentElement.style.setProperty("--hand-color", "rgba(50, 50, 50, 0.9)");
        document.documentElement.style.setProperty("--second-hand-color", "rgba(255, 107, 0, 1)");
        document.documentElement.style.setProperty("--primary-light-angle", "-45deg");
        document.documentElement.style.setProperty("--dark-edge-angle", "135deg");
        document.documentElement.style.setProperty("--shadow-layer1-opacity", "0.1");
        document.documentElement.style.setProperty("--shadow-layer2-opacity", "0.1");
        document.documentElement.style.setProperty("--shadow-layer3-opacity", "0.1");
        // Update seconds mode
        secondsMode = "smooth";
        animateSecondHand();
        // Update shadow elements directly
        const innerShadowElements = [
          document.querySelector(".glass-edge-shadow"),
          document.querySelector(".glass-dark-edge")
        ];
        ...
        const outerShadowElement = document.querySelector(".glass-effect-shadow");
